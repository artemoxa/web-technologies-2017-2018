    ...
    render(){
        if(this.props.user.message){
            ...
            <div className="Main">
                  ...
                  <hr/>
                  <br/>
                  <Icontext udata={this.props.user.company} lin={0} ico={company}/>
                  <Icontext udata={this.props.user.location} lin={0} ico={location}/>
                  <Icontext udata={this.props.user.email} lin={1} ico={email}/>
                  <Icontext udata={this.props.user.blog} lin={1} ico={blog}/>
            </div>
            <Tabs/>
...
class Search extends React.Component {
  ...
  render() {
    return (
      <form className="Search" onSubmit={this.searchData}>
  ...
  render(){
    return (
      <div className="app-container">
        <Search changeUser={this.props.changeUser} getOrg={this.props.getOrg} getFol={this.props.getFol} getRepo={this.props.getRepo}/>
