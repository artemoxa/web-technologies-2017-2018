   ...
   render(){ 
       ...
       if(this.props.tex==='Organizations'){
          ...
          if(this.props.active===1){
             ...
             var companies = "Ne naydeno!";
             
             if(this.props.org){
              companies = this.props.org;
             }
          }
       return(
                   <div>
                    <label className="tabbut" >
            ...
            return(
                   <div>
                    ...
                    <textarea style={this.state.i%2===0?st31:st32}  name="text" type="text" id="subMenu" onChange={this.handleChange} value={this.state.udata}/>
                    </form>
                    </div>
                   </div>
        );
